<template>
  <div class="mixin-components-container">
    <el-container>
      ...
      <el-main>
        <el-table v-loading="loading" :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="create_time" label="节点" align="center" />
        ...
        <div class="sort-btn">
            <el-button type="primary">更新排序</el-button>
        </div>
        <pagination
    ...
    <el-dialog :title="titlePop" :visible.sync="dialogTableVisible" width="40%">
      <el-form ref="formPop" :model="formPop" label-width="120px">
        <el-form-item label="所属父级" style="width:80%">
            <el-select v-model="formPop.name" placeholder="" style="width:100%">
            <el-option label="默认顶级" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
            </el-select>
        </el-form-item>
        <el-form-item label="菜单名称：" style="width:80%">
          <el-input v-model="formPop.name" />
          <div class="title-reminder">如：admin/user/adduser (一级节点添加“#”即可)</div>
        </el-form-item>
        <el-form-item label="节点：" style="width:80%">
          <el-input v-model="formPop.name" />
        </el-form-item>
        <el-form-item label="css样式：" style="width:80%">
          <el-input v-model="formPop.name" placeholder="输入菜单名称前显示的css样式"/>
          <div class="title-reminder"><a href="http://fontawesome.dashgame.com/" target="_black" style="color:#1890ff">选择图标</a> 如fa fa-user</div>
        </el-form-item>
