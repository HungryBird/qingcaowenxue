  ...
  <div class="mixin-components-container">
    <el-container>
      ...
      <el-main>
        <el-table v-loading="loading" :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="create_time" label="真实密码" width="140" align="center" />
          <el-table-column prop="create_time" label="管理员角色" width="140" align="center" />
          <el-table-column prop="create_time" label="上次登录时间" width="140" align="center" />
          <el-table-column prop="create_time" label="真实姓名" width="140" align="center" />
          <el-table-column prop="create_time" label="抽成比例" width="140" align="center" />
          ...
          <el-table-column prop="caozuo" label="操作" align="center">
            <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="handleEdit(scope.row)">推荐微信菜单</el-button>
              <el-button size="mini" type="primary" @click="handleDelete(scope.row)">微信配置</el-button>
    ...
    <el-dialog :title="titlePop" :visible.sync="dialogTableVisible" width="60%">
      <el-form ref="formPop" :model="formPop" label-width="120px">
        <el-form-item label="管理员名称：" style="width:80%">
          <el-input v-model="formPop.name" />
        </el-form-item>
        <el-form-item label="管理员角色：" style="width:80%">
           <el-select v-model="formPop.adminRole" placeholder="请选择管理员角色" style="width:100%">
        ...
        <el-form-item label="上级会员：" style="width:80%">
            <el-select v-model="formPop.member" placeholder="请选择上级会员" style="width:100%">
                <el-option label="区域一" value="shanghai"></el-option>
                <el-option label="区域二" value="beijing"></el-option>
            </el-select>
        </el-form-item>
